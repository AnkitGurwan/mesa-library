...
const File = (props) => {
  ...
  return (
    <div className='rounded-sm md:rounded-none hover:scale-105 relative mr-4 mt-4 bg-[url("https://cdn3.vectorstock.com/i/1000x1000/49/32/user-guide-book-vector-25754932.jpg")]' style={{"background-size":"cover","background-repeat":"no-repeat","background-position": "center center","backgroundColor":"white" }}>
      <div onClick={()=>{!flag?setFlag(true):setFlagg(false)}} className='w-24 h-28 flex justify-center items-end  cursor-pointer backdrop-brightness-100'>
