...
const File = (props) => {
  ...
  return (
    <div className='hover:scale-105 relative mr-4 mt-4 bg-[url("https://cdn3.vectorstock.com/i/1000x1000/49/32/user-guide-book-vector-25754932.jpg")]' style={{"background-size":"cover","background-repeat":"no-repeat","background-position": "center center","backgroundColor":"white" }}>
