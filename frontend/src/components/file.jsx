...
const File = (props) => {
  ...
  return (
    <div onClick={()=>{!flag?setFlag(true):setFlagg(false)}} className='py-6 mx-4 border w-20 h-24 flex flex-col justify-center items-center hover:bg-gray-100 cursor-pointer'>
